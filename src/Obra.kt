class Obra {
    ...
    fun totalInsumos() :Obra{
        ...
        println("Valor Total com Insumos: ${total}")
    ...
    fun gastosComMaoDeObra() :Obra{
        ...
        println("Valor Total com Mão de Obra: ${total}")
        return this
    }
    ...
    fun gastoComEqupamentos() :Obra{
        ...
        println("Valor Total com Equipamentos: ${total}")
        return this
    }
    ...
    fun totalGasto(){
        ...
        println("TOTAL GASTOS: ${this.gastoTotal}")
    }
